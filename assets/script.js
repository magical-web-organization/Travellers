...
var Editor, editor;
	...
	async function edit(){
		...
		toast_js.onload = async function(){
			...
			// fetch the md
			let request = await fetch("http://localhost/magical-web-presence/Markdownitor_travel.php?type=fetch&post="+window.location.pathname);
	...
	function save(){
		...
		fetch("http://localhost/magical-web-presence/Markdownitor_travel.php?type=save&post="+window.location.pathname, options)
		  .then(response => {
			if (response.ok) {
	...
	function del(){
		...
		fetch("http://localhost/magical-web-presence/Markdownitor_travel.php?type=delete&post="+window.location.pathname)
		  .then(response => {
			if (response.ok) {
			  return response.json();
			} else {
